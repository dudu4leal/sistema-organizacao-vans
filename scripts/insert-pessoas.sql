-- ============================================================
-- SCRIPT: Inserir Apenas as Pessoas
...
INSERT OR REPLACE INTO Usuarios (Id, Nome, Telefone, RotaPreferencialId, GrupoId, CriadoEm, AtualizadoEm)
SELECT 'b1000005-0000-4000-8000-000000000005', 'Léo Mussel',      '(24) 99901-0005', r.Id, NULL, datetime('now'), datetime('now')
FROM Rotas r WHERE r.Nome = 'Cascatinha';
...
INSERT OR REPLACE INTO Usuarios (Id, Nome, Telefone, RotaPreferencialId, GrupoId, CriadoEm, AtualizadoEm)
SELECT 'b1000007-0000-4000-8000-000000000007', 'Mãe Mussel',      '(24) 99901-0007', r.Id, NULL, datetime('now'), datetime('now')
FROM Rotas r WHERE r.Nome = 'Cascatinha';
...
INSERT OR REPLACE INTO Usuarios (Id, Nome, Telefone, RotaPreferencialId, GrupoId, CriadoEm, AtualizadoEm)
SELECT 'b1000012-0000-4000-8000-000000000012', 'Léo Silva',       '(24) 99901-0012', r.Id, NULL, datetime('now'), datetime('now')
FROM Rotas r WHERE r.Nome = 'Cascatinha';
...
INSERT OR REPLACE INTO Usuarios (Id, Nome, Telefone, RotaPreferencialId, GrupoId, CriadoEm, AtualizadoEm)
SELECT 'b1000017-0000-4000-8000-000000000017', 'João Bernardo',   '(24) 99902-0002', r.Id, NULL, datetime('now'), datetime('now')
FROM Rotas r WHERE r.Nome = 'Bingen';
...
INSERT OR REPLACE INTO Usuarios (Id, Nome, Telefone, RotaPreferencialId, GrupoId, CriadoEm, AtualizadoEm)
SELECT 'b1000027-0000-4000-8000-000000000027', 'Guilherme França','(24) 99903-0002', r.Id, NULL, datetime('now'), datetime('now')
FROM Rotas r WHERE r.Nome = 'Quitandinha';
...
INSERT OR REPLACE INTO Usuarios (Id, Nome, Telefone, RotaPreferencialId, GrupoId, CriadoEm, AtualizadoEm)
SELECT 'b1000034-0000-4000-8000-000000000034', 'Tia Valéria Gama','(24) 99903-0009', r.Id, NULL, datetime('now'), datetime('now')
FROM Rotas r WHERE r.Nome = 'Quitandinha';

INSERT OR REPLACE INTO Usuarios (Id, Nome, Telefone, RotaPreferencialId, GrupoId, CriadoEm, AtualizadoEm)
SELECT 'b1000035-0000-4000-8000-000000000035', 'Márcia Gama',     '(24) 99903-0010', r.Id, NULL, datetime('now'), datetime('now')
FROM Rotas r WHERE r.Nome = 'Quitandinha';

INSERT OR REPLACE INTO Usuarios (Id, Nome, Telefone, RotaPreferencialId, GrupoId, CriadoEm, AtualizadoEm)
SELECT 'b1000036-0000-4000-8000-000000000036', 'Luís Gustavo',    '(24) 99903-0011', r.Id, NULL, datetime('now'), datetime('now')
FROM Rotas r WHERE r.Nome = 'Quitandinha';
...
INSERT OR REPLACE INTO Usuarios (Id, Nome, Telefone, RotaPreferencialId, GrupoId, CriadoEm, AtualizadoEm)
SELECT 'b1000043-0000-4000-8000-000000000043', 'César Vallejo',   '(24) 99904-0004', r.Id, NULL, datetime('now'), datetime('now')
FROM Rotas r WHERE r.Nome = 'Centro';
